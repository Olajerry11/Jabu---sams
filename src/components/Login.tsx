...
export default function Login() {
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center p-4 sm:p-8 relative overflow-hidden bg-slate-50">
      ...
      <div className={`w-full max-w-5xl grid lg:grid-cols-2 gap-8 lg:gap-0 bg-white/80 backdrop-blur-2xl rounded-[2.5rem] premium-shadow overflow-hidden transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
